    ...
    <section className='card group flex items-center'>
      {latestWeight ? (
        <p className='text-lg w-[150px]'>
          ...
          <span className='block text-sm text-gray-500'> as of {latestWeight.date}</span>
          <span className='mt-4 hidden group-hover:block text-md text-primary font-bold'> Click to register new weight </span>
        </p>
      ) : (
