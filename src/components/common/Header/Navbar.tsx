  ...
  return (
    <nav className="flex justify-end w-full">
      ...
      <ul className="hidden md:flex gap-8">
        ...
        <li ><NavLink to="/profile" className="p-4 hover:bg-accent rounded-md" ><User className="inline self-center h-full mr-2"/>Profil</NavLink></li>
      ...
      {isOpen && (
        <ul className="md:hidden flex flex-col mt-4">
          ...
          <li className="my-2"><NavLink to="/profile" className="px-4 py-2 hover:bg-accent rounded-md">Profile</NavLink></li>
